...
from SACHINxUSERBOT.database.pmpermitdb import get_approved_users, pm_guard
import SACHINxUSERBOT.database.pmpermitdb as SACHINxUSERBOT
...
async def pmguard(client, message):
    ...
    if not arg:
        ...
        return
    await SACHINxUSERBOT.set_limit(int(arg))
...
async def setpmmsg(client, message):
    ...
    if not arg:
        ...
        return
    if arg == "default":
        await SACHINxUSERBOT.set_block_message(SACHINxUSERBOT.BLOCKED)
        await message.edit("**Block message set to default**.")
        return
    await SACHINxUSERBOT.set_block_message(f"`{arg}`")
...
async def allow(client, message):
    ...
    pmpermit, pm_message, limit, block_message = await SACHINxUSERBOT.get_pm_settings()
    await SACHINxUSERBOT.allow_user(chat_id)
...
async def deny(client, message):
    chat_id = message.chat.id
    await SACHINxUSERBOT.deny_user(chat_id)
