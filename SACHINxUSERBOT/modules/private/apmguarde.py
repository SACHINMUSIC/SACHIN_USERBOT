...
async def pmguard(client, message):
    ...
    if not arg:
        ...
        return
    if arg == "off":
        await SACHINxUSERBOT.set_pm(False)
        await message.edit("**PM Guard Deactivated**")
    if arg == "on":
        await SACHINxUSERBOT.set_pm(True)
...
async def setpmmsg(client, message):
    ...
    if not arg:
        ...
        return
    if arg == "default":
        await SACHINxUSERBOT.set_permit_message(SACHINxUSERBOT.PMPERMIT_MESSAGE)
        await message.edit("**Anti_PM message set to default**.")
        return
    await SACHINxUSERBOT.set_permit_message(f"`{arg}`")
